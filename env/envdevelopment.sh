...
export SERVER_URL=https://dev2-mywell-server.marvi.org.in
...
export REACT_APP_GRAPHQL_ENDPOINT="https://dev2-mywell-gql.marvi.org.in/graphql"
export UI_BUCKET_NAME="dev2-mywell.marvi.org.in"
