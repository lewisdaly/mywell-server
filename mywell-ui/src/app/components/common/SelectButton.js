...
class SelectButton extends Component {
  ...
  getButtons() {
    return this.props.buttonConfig.map((buttonConfig, idx) => {
      ...
      let className = "f5 no-underline white bg-dark-gray bg-animate inline-flex items-center ph3 ba  b--dark-gray border-box";
      if (idx == this.state.selectedIndex) {
        className="f5 no-underline dark-gray bg-animate inline-flex items-center ph3 ba border-box";
      }
